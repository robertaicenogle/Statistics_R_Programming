...
An overview of the R Program. Instructions for R installation, data import, data visualization, statistical tests, hypothesis testing, analysis of means, correlation and regression analysis
